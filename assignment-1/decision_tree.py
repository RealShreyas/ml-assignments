...
class Dtree_Node:
    def __init__(self,input,output,indexes):
        ...
        self.score = float('inf') #initialise the variance of leaf nodes to infinity
        self.split_dataset()  # function to find where to split the dataset


    def find_best_attribute_to_split(self,split_attribute_index):  #checks if current attribute reduces variance of node
    ...
    def score_node(self,left_split,right_split):
        ...
        return var_left * left_split.sum() + var_right * right_split.sum()   #using weighted average of variance as score
